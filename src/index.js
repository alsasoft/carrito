...
describe("Carrito", () => {
    ...
    it(`Intento añadir {} productos '${productoChupete.getDescription()}'`, () => {
        expect(() => {
            carrito.anadir(productoChupete, {});
        }).toThrowError(Error);
        expect(carrito.esVacio()).toEqual(true);
        expect(carrito.numeroItems()).toEqual(0);
        expect(carrito.obtenerCantidad(productoChupete)).toEqual(0);
    ...
    it(`Intento añadir 'notAnumber' productos '${productoChupete.getDescription()}'`, () => {
        expect(() => {
            carrito.anadir(productoChupete, 'notAnumber');
        }).toThrowError(Error);
        expect(carrito.esVacio()).toEqual(true);
        expect(carrito.numeroItems()).toEqual(0);
        expect(carrito.obtenerCantidad(productoChupete)).toEqual(0);
    ...
    it(`Intento retirar 'notAnumber' productos '${productoChupete.getDescription()}'`, () => {
        expect(() => {
            carrito.retirar(productoChupete, 'notAnumber');
        }).toThrowError(Error);
        expect(carrito.esVacio()).toEqual(true);
        expect(carrito.numeroItems()).toEqual(0);
        expect(carrito.obtenerCantidad(productoChupete)).toEqual(0);
